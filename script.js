(() => {
  ...
  // ---------------------------------------------------------
  // Scroll-reveal for form sections (purely visual, additive)
  // ---------------------------------------------------------
  ...
  // ---------------------------------------------------------
  // Animate the score number counting up to its final value
  // (purely presentational — final displayed value is identical
  // to the API response, just reached via a short animation)
  // ---------------------------------------------------------
  ...
  function renderResult(score) {
    ...
    if (gaugeNeedle) gaugeNeedle.style.transition = "none";
